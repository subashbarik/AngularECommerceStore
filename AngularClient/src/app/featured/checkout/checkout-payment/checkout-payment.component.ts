  ...
  implements AfterViewInit, OnDestroy, OnInit
{
  ...
  ngOnInit(): void {
    this.paymentForm = this.checkoutForm.get('paymentForm');
  }
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe(
      'pk_test_51LaX82SGa4a4CFcU7FPQNLip6XJi0V1PuviBPBfEDQSDdY66pNgZgmd8Gn5Q9S5xrSl2EUsQYOtlNmkVE2HA4T8w00ZrnPo5uJ'
    );
